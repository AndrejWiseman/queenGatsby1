            ...
            <section className="section1">
                ...
                <div className="njegaBox">
                    ...
                    <div className="uslugeTekst">
                        ...
                        {/*<h3>Pedikir</h3>*/}
                        <p className='opisUsluge'>Korekcija obrva u kozmetičkom salonu je usluga koja pomaže u oblikovanju i definisanju obrva. Korekcija obrva uključuje uklanjanje viška dlačica s obrva i oblikovanje obrva prema željenoj veličini, obliku i stilu. Uz to, možete zatražiti i bojanje obrva kako biste poboljšali njihov izgled i naglasili njihovu prirodnu boju.</p>

                        <h3>Henna obrve</h3>
                        <p className='opisUsluge'>Henna obrve su prirodna alternativa bojanju obrva koja se sve više koristi u kozmetičkim salonima. Henna je biljni prah koji se dobiva od sušenih listova kane biljke. Kada se pomiješa s vodom ili drugom tekućinom, Henna stvara pastu koja se nanosi na obrve kako bi ih obojila.
